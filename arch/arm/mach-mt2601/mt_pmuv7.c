...
static inline int armv7_pmnc_counter_has_overflowed(unsigned long pmnc, int counter)
{
	int ret = 0;
...
static inline u32 armv7_pmnc_enable_counter(unsigned int idx)
{
	...
	if ((idx != ARMV7_CYCLE_COUNTER) && ((idx < ARMV7_COUNTER0) || (idx > ARMV7_COUNTER_LAST))) {
