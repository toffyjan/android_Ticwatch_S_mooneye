...
#define MTK_SDIO30_ONLINE_TUNING_SUPPORT //Although MSDC1 doesn't support ACMD53, we need to enable it to apply setting wihout actual performance of online-tuning
//#define OT_LATENCY_TEST

//#define AUTOK_UT
#ifdef AUTOK_UT
//#define SDIO_UT_WITHOUT_6630_DRIVER
#endif

//Either USE_CPUFREQ_API or USE_VCORE_DVFS_API shall be difined if AUTOK will be used
#define USE_CPUFREQ_API                 
//#define USE_VCORE_DVFS_API

#endif  // CONFIG_SDIOAUTOK_SUPPORT

//#define AUTOK_THRESHOLD_FREQ 100000000 //Frequency <= the threshold will be used without enabling AUTOK
#define AUTOK_THRESHOLD_FREQ 50000000
...
//#define SDIO_LIMIT_FREQ
#define MSDC1_SDIO          //FIX ME: Temp placed here, may be moved to board.h later
#define USE_SDIO_1V8
#define MSDC_DATA1_INT  1   //FIX ME: Temp placed here, may be moved to board.h later
//#define SDIO_AUTOK_UT_NO_VOLTAGE_DEP //Enable in one of the 2 conditions
                                     // 1. AutoK does not depend on Vcore
                                     // 2. You don't know if autok depend on Vcore, but you can assume vcore is fixed

#ifdef MSDC1_SDIO
//#define MSDC1_SDIO_UT
#endif

//#define MSDC_DISABLE_HS400
//#define MSDC_DISABLE_HS200
//#define MSDC_DISABLE_SDR104
//#define MSDC_DISABLE_DDR50
//#define MSDC_DISABLE_SDR50

#ifdef CONFIG_MT2601_FPGA
...
#define MSDC0_IO_CONFIG_BASE    ((void __iomem *)IO_CFG_BOTTOM_BASE) //eMMC booting
#define MSDC1_IO_CONFIG_BASE    ((void __iomem *)IO_CFG_RIGHT_BASE)
...
struct msdc_host
{
    ...
    struct wakeup_source	trans_lock;       //driver will get a EINT(Level sensitive) when boot up phone with card insert
    bool                        block_bad_card;
