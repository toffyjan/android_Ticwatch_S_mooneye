...
#define MALIK_MSG(fmt, arg...)   { MALIK_PRINTF("Mali: %s(): "fmt, __func__, ##arg); }
#define MALIK_ERRMSG(fmt, arg...)   { MALIK_PRINTF("Mali Error: %s()@%s:line %d: "fmt, __func__, __FILE__, __LINE__, ##arg);  MTKMALI_DumpRegister(); }
#define MALIK_WARNMSG(fmt, arg...)  { MALIK_PRINTF("Mali Warn: %s(): "fmt, __func__, ##arg); }
