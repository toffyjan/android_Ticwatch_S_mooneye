...
/********* Step A *************************************/
    ...
    SETREG16(USBPHYRegs+0x1C, 0x1000);
    CLRREG16(USBPHYRegs+0x1C, 0x0400);
...
void PMIC_INIT_SETTING_V1(void)
{
	...
	/* put init setting from DE/SA */
        ...
        ret = pmic_config_interface(0x254, 0x58, 0x7F, 8);
        ret = pmic_config_interface(0x254, 0x38, 0x7F, 0);
        ret = pmic_config_interface(0x256, 0x38, 0x7F, 0);
        ret = pmic_config_interface(0x2, 0xB, 0xF, 4);
        ret = pmic_config_interface(0xC, 0x2, 0x7, 1);
        ...
        ret = pmic_config_interface(0x14C, 0x0, 0xF, 12);
        ret = pmic_config_interface(0x14C, 0x0, 0xF, 8);
        ret = pmic_config_interface(0x14C, 0x0, 0xF, 4);
        ret = pmic_config_interface(0x14C, 0x0, 0xF, 0);
        ret = pmic_config_interface(0x156, 0x1, 0x1, 3);
        ret = pmic_config_interface(0x156, 0x1, 0x1, 2);
        ret = pmic_config_interface(0x156, 0x1, 0x1, 1);
        ret = pmic_config_interface(0x15A, 0x1, 0x1, 15);
        ret = pmic_config_interface(0x15A, 0x1, 0x1, 14);
        ret = pmic_config_interface(0x15A, 0x1, 0x1, 13);
        ret = pmic_config_interface(0x15C, 0x1, 0x1, 0);
        ret = pmic_config_interface(0x174, 0x2, 0xF, 12);
        ret = pmic_config_interface(0x174, 0x2, 0xF, 8);
        ret = pmic_config_interface(0x176, 0x2, 0xF, 4);
        ret = pmic_config_interface(0x176, 0x2, 0xF, 0);
        ret = pmic_config_interface(0x178, 0x1, 0x1, 11);
        ret = pmic_config_interface(0x178, 0x1, 0x1, 10);
        ret = pmic_config_interface(0x204, 0x1, 0x1, 2);
        ret = pmic_config_interface(0x204, 0x1, 0x1, 1);
        ret = pmic_config_interface(0x204, 0x1, 0x1, 0);
        ret = pmic_config_interface(0x20C, 0x2, 0x3, 4);
        ret = pmic_config_interface(0x20C, 0x3, 0x3, 0);
        ...
        ret = pmic_config_interface(0x216, 0x11, 0x7F, 8);
        ret = pmic_config_interface(0x216, 0x23, 0x7F, 0);
        ret = pmic_config_interface(0x22A, 0x1, 0x1, 8);
        ret = pmic_config_interface(0x22A, 0x1, 0x3, 4);
        ret = pmic_config_interface(0x22A, 0x3, 0x3, 0);
        ret = pmic_config_interface(0x232, 0x2, 0x3, 4);
        ret = pmic_config_interface(0x232, 0x3, 0xF, 0);
        ...
        ret = pmic_config_interface(0x23C, 0x11, 0x7F, 8);
        ret = pmic_config_interface(0x23C, 0x23, 0x7F, 0);
        ret = pmic_config_interface(0x250, 0x1, 0x1, 8);
        ret = pmic_config_interface(0x250, 0x1, 0x3, 4);
        ret = pmic_config_interface(0x250, 0x3, 0x3, 0);
        ret = pmic_config_interface(0x260, 0x2, 0xF, 0);
        ret = pmic_config_interface(0x262, 0x1, 0x1, 1);
        ret = pmic_config_interface(0x268, 0x1, 0x1, 15);
        ret = pmic_config_interface(0x268, 0x11, 0x7F, 8);
        ret = pmic_config_interface(0x268, 0x23, 0x7F, 0);
        ret = pmic_config_interface(0x27C, 0x1, 0x1, 8);
        ret = pmic_config_interface(0x27C, 0x1, 0x3, 0);
        ret = pmic_config_interface(0x2A2, 0x1, 0x1, 8);
        ret = pmic_config_interface(0x2A2, 0x1, 0x3, 0);
        ret = pmic_config_interface(0x328, 0x1, 0x3, 14);
        ret = pmic_config_interface(0x328, 0x1, 0x3, 12);
        ret = pmic_config_interface(0x328, 0x1, 0x3, 10);
        ret = pmic_config_interface(0x328, 0x2, 0x3, 8);
        ret = pmic_config_interface(0x328, 0x1, 0x3, 0);
        ret = pmic_config_interface(0x32C, 0x3, 0x3, 0);
        ret = pmic_config_interface(0x336, 0x1, 0x1, 15);
        ret = pmic_config_interface(0x336, 0x1, 0x1, 7);
        ret = pmic_config_interface(0x346, 0x3, 0x3, 4);
        ret = pmic_config_interface(0x346, 0x3, 0x3, 0);
        ret = pmic_config_interface(0x34C, 0x1, 0x1, 0);
        ret = pmic_config_interface(0x37C, 0x1, 0x3, 8);
        ret = pmic_config_interface(0x37C, 0x2, 0x3, 6);
        ret = pmic_config_interface(0x37C, 0x1, 0x3, 4);
        ret = pmic_config_interface(0x37C, 0x4, 0x7, 0);
        ret = pmic_config_interface(0x37E, 0x1, 0x1, 8);
        ret = pmic_config_interface(0x380, 0x3, 0x3, 0);
        ret = pmic_config_interface(0x38C, 0x4, 0x1F, 0);
        ret = pmic_config_interface(0x45C, 0x0, 0x7, 5);
        ret = pmic_config_interface(0x45E, 0x0, 0x7, 5);
        ret = pmic_config_interface(0x464, 0xE, 0xF, 8);
        ret = pmic_config_interface(0x466, 0x1, 0x1, 2);
        ret = pmic_config_interface(0x468, 0x1, 0x1, 4);
        ...
        ret = pmic_config_interface(0x50C, 0x1, 0x1, 5);
        ret = pmic_config_interface(0x510, 0x1, 0x1, 1);
        ret = pmic_config_interface(0x510, 0x1, 0x1, 0);
        ret = pmic_config_interface(0x540, 0x3, 0x7, 4);
        ret = pmic_config_interface(0x55C, 0xFC, 0xFF, 8);
        ret = pmic_config_interface(0x55E, 0x1, 0x1, 1);
        ret = pmic_config_interface(0x564, 0x1, 0x1, 1);
	...
	/* put init setting from DE/SA */
        ...
        ret = pmic_config_interface(0x20C, 0x3, 0x3, 0);
        ret = pmic_config_interface(0x210, 0x1, 0x1, 4);
        ret = pmic_config_interface(0x210, 0x1, 0x1, 2);
        ret = pmic_config_interface(0x210, 0x1, 0x1, 1);
        ret = pmic_config_interface(0x216, 0x1, 0x1, 15);
        ret = pmic_config_interface(0x216, 0x11, 0x7F, 8);
        ret = pmic_config_interface(0x216, 0x23, 0x7F, 0);
        ret = pmic_config_interface(0x224, 0x0, 0x3, 8);
        ret = pmic_config_interface(0x22A, 0x1, 0x1, 8);
        ret = pmic_config_interface(0x22A, 0x1, 0x3, 4);
        ret = pmic_config_interface(0x22A, 0x3, 0x3, 0);
        ret = pmic_config_interface(0x232, 0x2, 0x3, 4);
	...
	/* ret = pmic_config_interface(0x260,0xF2,0xFF,0); // [7:0]: RG_VCORE_RSV; */
        ...
        ret = pmic_config_interface(0x262, 0x1, 0x1, 2);
        ret = pmic_config_interface(0x262, 0x1, 0x1, 1);
        ret = pmic_config_interface(0x268, 0x1, 0x1, 15);
        ret = pmic_config_interface(0x268, 0x11, 0x7F, 8);
        ret = pmic_config_interface(0x268, 0x23, 0x7F, 0);
        ret = pmic_config_interface(0x276, 0x0, 0x3, 8);
        ret = pmic_config_interface(0x27C, 0x1, 0x1, 8);
        ret = pmic_config_interface(0x27C, 0x1, 0x3, 0);
        ret = pmic_config_interface(0x288, 0x1, 0x1, 2);
        ret = pmic_config_interface(0x29C, 0x0, 0x3, 8);
        ret = pmic_config_interface(0x2A2, 0x1, 0x1, 8);
        ret = pmic_config_interface(0x2A2, 0x1, 0x3, 0);
        ret = pmic_config_interface(0x328, 0x1, 0x3, 10);
        ret = pmic_config_interface(0x328, 0x1, 0x3, 0);
